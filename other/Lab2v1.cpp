...
/*
дана непрямоугольная матрица высотой m
создать массив b[m], i-й элемент которого является суммой элементов из i-й строки матрицы, больших, чем среднее значение в этой строке
*/
